...
//
    ...
    //thangle = BANG2RAD(bamsAtan2((v1[VY]-FIX2FLT(viewy))*10,
    //(v1[VX]-FIX2FLT(viewx))*10)) - PI/2;
...
//
    ...
    {
        y += PSpriteSY[viewplayer->class][players[consoleplayer].readyweapon]
             >> FRACBITS;
    }
    else
        y -= 39/2;
